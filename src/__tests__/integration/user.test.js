...
describe('User Model Tests', () => {
  ...
  describe('Date of Birth ', () => {
    it('Should date of birth field be required if the user is a fighter', async () => {
      ...
      expect(validationErrors.errors.dateOfBirth.message).toBe(
  ...
  describe.skip('Business', () => {
    ...
    it('Should the user verification number be optional if business name is not provided', () => {
      ...
      const validationErrors = user.validateSync();
      expect(
        validationErrors.errors.business.verificationNumber
      ).not.toBeDefined();
    });
  ...
  describe('Website', () => {
    ...
    it('Should throw an error if the website is not a valid URL', () => {
      ...
      expect(validationErrors.errors.website.message).toBe(
